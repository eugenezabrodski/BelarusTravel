    ...
    var body: some View {
        VStack {
            ...
            VStack(alignment: .center, spacing: 20) {
                //PlaceImage(url: place?.place?.photoURL!)
                VStack {
...
struct InformationView_Previews: PreviewProvider {
    static var previews: some View {
        InformationView(place: TravelType(nameType: "nn", place: Place(namePlace: "qwe", text: "12333333333", coordinates: nil, photoURL: nil)))
    }
}
